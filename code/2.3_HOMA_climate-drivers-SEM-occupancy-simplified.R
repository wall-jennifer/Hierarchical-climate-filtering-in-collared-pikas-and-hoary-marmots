# HOMA_climate-drivers-SEM-occupancy-simplified
...
inits.simp <- function() {
  ...
  return(list(a3 = a3, g0 = g0, g1 = g1, g2 = g2, g3 = g3, g4 = g4,
              bO1 = b0[1], bO2 = b0[2], bO3 = b0[3]))
}


sink("SEMOcc_SimplifiedSimulation_HOMA2025.jags")
cat("

model{
  # Priors
  a3 ~ dnorm(0.15, 0.5)   # evi ~ a3*heat
  ...
  g3 ~ dnorm(-0.25, 0.5)  # psi ~ ros
  g4 ~ dnorm(-0.25, 0.5)  # psi ~ cold
...
HOMA_testocc_simplified <- jagsUI::jags(data = HOMA.climate.jags_data, 
                                        inits=inits.simp,
                                        model.file = "SEMOcc_SimplifiedSimulation_HOMA2025.jags",
...
mcmcOutput::diagPlot(HOMA_testocc_simplified) # diagnostic plots
print(HOMA_testocc_simplified)
